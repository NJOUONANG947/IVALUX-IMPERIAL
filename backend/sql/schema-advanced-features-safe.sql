-- =====================================================
-- IVALUX IMPERIAL - Advanced Features Schema (Safe Version)
-- Analyse comportementale, Métavers, IA avancée
-- This version creates missing tables if they don't exist
-- =====================================================
...
DROP TRIGGER IF EXISTS user_avatars_updated_at ON public.user_avatars;
